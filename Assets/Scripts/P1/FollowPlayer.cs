...
public class FollowPlayer : MonoBehaviour
{
    ...
    // public Vector3 offset_1 = new Vector3(0, 5, -7); // Offset from the player position
    // public Vector3 offset_2 = new Vector3(0, 2.5f, 0.5f); // Offset from the player position
